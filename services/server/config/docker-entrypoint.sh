...
runuser -l $XPRA_USER -c "pulseaudio --start; pulseaudio --kill; XPRA_KEYCLOAK_SERVER_URL=$XPRA_KEYCLOAK_SERVER_URL XPRA_KEYCLOAK_REALM_NAME=$XPRA_KEYCLOAK_REALM_NAME XPRA_KEYCLOAK_CLIENT_ID=$XPRA_KEYCLOAK_CLIENT_ID XPRA_KEYCLOAK_CLIENT_SECRET_KEY=$XPRA_KEYCLOAK_CLIENT_SECRET_KEY XPRA_KEYCLOAK_REDIRECT_URI=$XPRA_KEYCLOAK_REDIRECT_URI XPRA_KEYCLOAK_SCOPE=$XPRA_KEYCLOAK_SCOPE XPRA_KEYCLOAK_GROUPS_CLAIM=$XPRA_KEYCLOAK_GROUPS_CLAIM XPRA_KEYCLOAK_AUTH_GROUPS=$XPRA_KEYCLOAK_AUTH_GROUPS XPRA_KEYCLOAK_AUTH_CONDITION=$XPRA_KEYCLOAK_AUTH_CONDITION XPRA_KEYCLOAK_GRANT_TYPE=$XPRA_KEYCLOAK_GRANT_TYPE xpra start :80 --bind-tcp=0.0.0.0:8080$AUTH --html=on --no-daemon --ssl-cert /etc/xpra/ssl-cert.pem --start='xhost +' -d auth"
...
#runuser -l $XPRA_USER -c "pulseaudio --start; pulseaudio --kill; XPRA_KEYCLOAK_SERVER_URL=$XPRA_KEYCLOAK_SERVER_URL XPRA_KEYCLOAK_REALM_NAME=$XPRA_KEYCLOAK_REALM_NAME XPRA_KEYCLOAK_CLIENT_ID=$XPRA_KEYCLOAK_CLIENT_ID XPRA_KEYCLOAK_CLIENT_SECRET_KEY=$XPRA_KEYCLOAK_CLIENT_SECRET_KEY XPRA_KEYCLOAK_REDIRECT_URI=$XPRA_KEYCLOAK_REDIRECT_URI XPRA_KEYCLOAK_SCOPE=$XPRA_KEYCLOAK_SCOPE XPRA_KEYCLOAK_GRANT_TYPE=$XPRA_KEYCLOAK_GRANT_TYPE PYTHONPATH=$PYTHONPATH:/xpra xpra start :80 --bind-tcp=0.0.0.0:8080$AUTH --html=on --no-daemon --start='xhost +' -d auth"
